...
const Map = () => {
  ...
  return (
    <>
      <FloatingPanel setShowMarkers={setShowMarkers} setShowHeatMap={setShowHeatMap} showHeatMap={showHeatMap} data={data} setData={setData} handleMarkers={handleMarkers} handleRadius={handleRadius} initialData={initialData} filteredData={filteredData} setFilteredData={setFilteredData} />
