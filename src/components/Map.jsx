...
//         // Create infowindow instances
//         const infoWindowContent = `
//         ${item.name.includes("Laura") && item.city.includes("ROXBORO") ? '<div class="laura-header"><span> Your first sale! </span></div><br />' : '<div style="border-radius: 8px; width: 98%;"><img src="/logo.jpg" alt="Etsy Logo" style="width: 20px; height: 20px; margin: 0; padding: 0;" /><hr style="border-top: 0.5px solid black";></div>'}
//               <div id='modalContent'>
//                 ${item.item === "Italian Bandages, Italy Plasters, 30 pcs" ? `
//                     <div >
//                       <img src="/italyListingPic.avif" alt="Product image" style="width: 100px; height: 100px;"/>
